<?
if(strpos($_SERVER['HTTP_ORIGIN'], "docker")===false) {
...
<html>
	<head>
		<title>SWGOH Tools - Find your SWGOH Shard</title>
  ...
  <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
	...
	<div id="middleSolo">
		<h1><a href="http://www.swgoh.life/index.html">More Tools</a> &gt; Find your SWGOH Shard</h1>
		...
		<? if(empty($me) || empty($ally) || empty($user)) { ?>
			<p>Do you want to get in touch with the other players on your SWGOH shard?  Please enter as much information as you can, and we'll try to find your shardmates and give you their contact information, if possible.</p>
			...
			<form action="<?=$self?>" method="post">
				...
				<b>Enter the names of the top 10 people in your shard's Squad Arena right now:</b><br />
