...
<div id="middleSolo">
	...
	<div id="uploadForm" class="box">			
		<img src="http://swgoh.life/haat/p4_offsky.png" id="photo" />
	...
	<form action="squad_submit.php" method="post" id="details">
		...
		<select name="raid">
			...
			<option value="aath">Tank Takedown (AAT) - HEROIC</option>
			<option value="nasl">Sith Triumvirate (NASL) - TIER 6</option>
			<option value="hasl">Sith Triumvirate (HASL) - HEROIC</option>
		</select><br />
