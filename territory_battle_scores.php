		...
		<div class="half">
			...
			<table>
				...
				<?
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>60000000 AND gp<=65000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>65000000 AND gp<=70000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>70000000 AND gp<=75000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>75000000 AND gp<=80000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>80000000 AND gp<=85000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>85000000 AND gp<=90000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>90000000 AND gp<=95000000");
					while($row = $db->getNext($rs)) {
					...
					$rs = $db->query("SELECT avg(stars),count(stars),min(stars),max(stars) FROM swgoh_tb_scores WHERE gp>95000000 AND gp<=100000000");
					while($row = $db->getNext($rs)) {
